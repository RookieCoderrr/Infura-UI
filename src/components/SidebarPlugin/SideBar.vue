...
<!--        <h6 class="navbar-heading text-muted">Documentation</h6>-->
        ...
        <ul class="navbar-nav mb-md-3">
          ...
          <li class="nav-item "  @click="showDrop">
            <div class=" nav-link nav-focus"  style="color: white;height:56px;cursor: pointer;font-size: 16px;font-weight: 400;font-style: normal;font-family: 'PingFang SC'">
              <svg class="svg" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style="margin-right: 5%">
          ...
          <li class="nav-item  "  v-if="this.drop">
            <router-link class="nav-link nav-focus" to="/" style="color: white;height:56px;cursor: pointer;font-size: 16px;font-weight: 400;font-style: normal;font-family: 'PingFang SC'">
              <svg class="svg" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style="margin-right: 5%">
