...
<!--      </router-link>-->
      <div class="mt-5" style="">
        <div  style=";vertical-align:middle; display: inline-block"><el-avatar src="https://cube.elemecdn.com/0/88/03b0d39583f48206768a7534e55bcpng.png" ></el-avatar></div>
...
<!--        <h6 class="navbar-heading text-muted">Documentation</h6>-->
        ...
        <ul class="navbar-nav mb-md-3">
          ...
          <li class="nav-item ">
            <router-link class=" nav-link nav-focus" to="/management" style="color: white;height:56px;cursor: pointer;font-size: 16px;font-weight: 400;font-style: normal;font-family: 'PingFang SC'">
              <svg class="svg" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style="margin-right: 5%">
...
.nav-focus:focus .svg path{
  fill: #4D56E1!important;
}
.nav-focus:active .svg path{
  fill: #4D56E1 !important ;
}
